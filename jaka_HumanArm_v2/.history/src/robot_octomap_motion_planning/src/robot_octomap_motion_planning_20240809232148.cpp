...
using ArmVisionPlanning = rm_hand_interface::action::ArmVisionPlanning;
using ArmStatusa = rm_hand_interface::msg::ArmStatus;
using DexterousHand = DexterousHandarm_hand_interface::action::DexterousHand;
...
public:
    ...
    rclcpp_action::Server<DexterousHand>::SharedPtr m_action_server_;
