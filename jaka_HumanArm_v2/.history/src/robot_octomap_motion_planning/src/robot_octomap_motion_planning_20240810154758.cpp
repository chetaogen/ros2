...
public:
    ...
    void octomap_topic_subscribe( octomap_msgs::msg::Octomap &msg) const;                                                // 订阅障碍物的topic
...
void octomap_planning ::octomap_topic_subscribe(octomap_msgs::msg::Octomap &msg) const
{
    octomap_msgs::msg::Octomap m_octomap_msg = msg;
};
