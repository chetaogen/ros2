...
#include "arm_hand_interface/msg/armvisionplanning.hpp"
#include "arm_hand_interface/msg/dexteroushand.hpp"
...
public:
    octomap_planning() : Node("octomap_planning")
    {
        ...
        // 创建一个定时器，每 2000ms 发布一次PointCloud2消息
...
void octomap_planning :: publisher_timerCallback()
{
    ...
    /*
             创建一个pcl库的PointCloud对象
              pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud(new pcl::PointCloud<pcl::PointXYZRGB>);
               从PCD文件中加载点云数据，填充PointCloud数据
    ...
    */
    ...
    // 创建一个立方体,首先创建一个pcl类型的点云，并填充
    float table[8] = {0.15, 0.25, 0.35, 0.45, 0.55, 0.65, 0.75, 0.85};
    cloud.width = 512;
    cloud.height = 1;
...
void octomap_planning ::motion_planning_interface(octomap_msgs::msg::Octomap  octomap_msg)
{
