...
public:
    robot_control() : Node("robot_control")
    {
        ...
        this->m_dex_server_ = rclcpp_action::create_server<DexterousHand>(
            this, "DexterousHand",
            std::bind(&octomap_planning::handle_goal_hand, this, _1, _2),
            std::bind(&octomap_planning::handle_cancel_hand, this, _1),
            std::bind(&octomap_planning::handle_accepted_hand, this, _1));
    }
