...
#include "arm_hand_interface/action/detail/dexterous_hand__rosidl_typesupport_fastrtps_c.h"
...
using _DexterousHand_Goal__ros_msg_type = arm_hand_interface__action__DexterousHand_Goal;
...
size_t get_serialized_size_arm_hand_interface__action__DexterousHand_Goal(
  const void * untyped_ros_message,
...
static uint32_t _DexterousHand_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_arm_hand_interface__action__DexterousHand_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arm_hand_interface
size_t max_serialized_size_arm_hand_interface__action__DexterousHand_Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = arm_hand_interface__action__DexterousHand_Goal;
    is_plain =
      (
...
static size_t _DexterousHand_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arm_hand_interface__action__DexterousHand_Goal(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arm_hand_interface, action, DexterousHand_Goal)() {
...
using _DexterousHand_Result__ros_msg_type = arm_hand_interface__action__DexterousHand_Result;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    size_t size = 6;
    auto array_ptr = ros_message->hand_pose;
    cdr.serializeArray(array_ptr, size);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arm_hand_interface
size_t get_serialized_size_arm_hand_interface__action__DexterousHand_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DexterousHand_Result__ros_msg_type * ros_message = static_cast<const _DexterousHand_Result__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_arm_hand_interface__action__DexterousHand_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arm_hand_interface
size_t max_serialized_size_arm_hand_interface__action__DexterousHand_Result(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = arm_hand_interface__action__DexterousHand_Result;
    is_plain =
      (
...
static size_t _DexterousHand_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arm_hand_interface__action__DexterousHand_Result(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arm_hand_interface, action, DexterousHand_Result)() {
...
using _DexterousHand_Feedback__ros_msg_type = arm_hand_interface__action__DexterousHand_Feedback;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arm_hand_interface
size_t get_serialized_size_arm_hand_interface__action__DexterousHand_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DexterousHand_Feedback__ros_msg_type * ros_message = static_cast<const _DexterousHand_Feedback__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_arm_hand_interface__action__DexterousHand_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arm_hand_interface
size_t max_serialized_size_arm_hand_interface__action__DexterousHand_Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = arm_hand_interface__action__DexterousHand_Feedback;
    is_plain =
      (
...
static size_t _DexterousHand_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arm_hand_interface__action__DexterousHand_Feedback(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arm_hand_interface, action, DexterousHand_Feedback)() {
...
// already included above
// #include "arm_hand_interface/action/detail/dexterous_hand__functions.h"  // goal
...
using _DexterousHand_SendGoal_Request__ros_msg_type = arm_hand_interface__action__DexterousHand_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, arm_hand_interface, action, DexterousHand_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arm_hand_interface
size_t get_serialized_size_arm_hand_interface__action__DexterousHand_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DexterousHand_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _DexterousHand_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_arm_hand_interface__action__DexterousHand_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_arm_hand_interface__action__DexterousHand_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arm_hand_interface
size_t max_serialized_size_arm_hand_interface__action__DexterousHand_SendGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_arm_hand_interface__action__DexterousHand_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = arm_hand_interface__action__DexterousHand_SendGoal_Request;
    is_plain =
      (
...
static size_t _DexterousHand_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arm_hand_interface__action__DexterousHand_SendGoal_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arm_hand_interface, action, DexterousHand_SendGoal_Request)() {
...
using _DexterousHand_SendGoal_Response__ros_msg_type = arm_hand_interface__action__DexterousHand_SendGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arm_hand_interface
size_t get_serialized_size_arm_hand_interface__action__DexterousHand_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DexterousHand_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _DexterousHand_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_arm_hand_interface__action__DexterousHand_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arm_hand_interface
size_t max_serialized_size_arm_hand_interface__action__DexterousHand_SendGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = arm_hand_interface__action__DexterousHand_SendGoal_Response;
    is_plain =
      (
...
static size_t _DexterousHand_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arm_hand_interface__action__DexterousHand_SendGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arm_hand_interface, action, DexterousHand_SendGoal_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arm_hand_interface, action, DexterousHand_SendGoal)() {
...
using _DexterousHand_GetResult_Request__ros_msg_type = arm_hand_interface__action__DexterousHand_GetResult_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arm_hand_interface
size_t get_serialized_size_arm_hand_interface__action__DexterousHand_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DexterousHand_GetResult_Request__ros_msg_type * ros_message = static_cast<const _DexterousHand_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_arm_hand_interface__action__DexterousHand_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arm_hand_interface
size_t max_serialized_size_arm_hand_interface__action__DexterousHand_GetResult_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = arm_hand_interface__action__DexterousHand_GetResult_Request;
    is_plain =
      (
...
static size_t _DexterousHand_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arm_hand_interface__action__DexterousHand_GetResult_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arm_hand_interface, action, DexterousHand_GetResult_Request)() {
...
// already included above
// #include "arm_hand_interface/action/detail/dexterous_hand__functions.h"  // result
...
using _DexterousHand_GetResult_Response__ros_msg_type = arm_hand_interface__action__DexterousHand_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, arm_hand_interface, action, DexterousHand_Result
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arm_hand_interface
size_t get_serialized_size_arm_hand_interface__action__DexterousHand_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DexterousHand_GetResult_Response__ros_msg_type * ros_message = static_cast<const _DexterousHand_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_arm_hand_interface__action__DexterousHand_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_arm_hand_interface__action__DexterousHand_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arm_hand_interface
size_t max_serialized_size_arm_hand_interface__action__DexterousHand_GetResult_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_arm_hand_interface__action__DexterousHand_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = arm_hand_interface__action__DexterousHand_GetResult_Response;
    is_plain =
      (
...
static size_t _DexterousHand_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arm_hand_interface__action__DexterousHand_GetResult_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arm_hand_interface, action, DexterousHand_GetResult_Response)() {
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arm_hand_interface, action, DexterousHand_GetResult)() {
...
// already included above
// #include "arm_hand_interface/action/detail/dexterous_hand__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _DexterousHand_FeedbackMessage__ros_msg_type = arm_hand_interface__action__DexterousHand_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, arm_hand_interface, action, DexterousHand_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arm_hand_interface
size_t get_serialized_size_arm_hand_interface__action__DexterousHand_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DexterousHand_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _DexterousHand_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_arm_hand_interface__action__DexterousHand_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_arm_hand_interface__action__DexterousHand_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arm_hand_interface
size_t max_serialized_size_arm_hand_interface__action__DexterousHand_FeedbackMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_arm_hand_interface__action__DexterousHand_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = arm_hand_interface__action__DexterousHand_FeedbackMessage;
    is_plain =
      (
...
static size_t _DexterousHand_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arm_hand_interface__action__DexterousHand_FeedbackMessage(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arm_hand_interface, action, DexterousHand_FeedbackMessage)() {
