...
{
    int ret = m_JAKAZuRobot.servo_move_use_joint_LPF(cutoffFreq);
    return ret;
}
...
{
    rclcpp::Rate rate1(2);
  write_SeriesPort_modbus(1000, 1000, 1000, 1000, 1000, 1000, ANGLE_SET);
   rate1.sleep();
   write_SeriesPort_modbus(1000, 1000, 1000, 1000, 1000, 0, ANGLE_SET);
   rate1.sleep();
   write_SeriesPort_modbus(543, 568, 581, 594, 766, 0, ANGLE_SET);

}

bool judge0(uint16_t angle_1, uint16_t angle_2, uint16_t angle_3, uint16_t angle_4, uint16_t angle_5, uint16_t angle_6)
{
    return !(      abs(angle_1 - 543)  <= 50
                && abs(angle_2 - 568)  <= 50
                && abs(angle_3 - 581)  <= 50 
                && abs(angle_4 - 594)  <= 50 
                && abs(angle_5 - 766) <= 50 
...
void action5()     //好的手势
{
   ...
   write_SeriesPort_modbus(1000, 1000, 1000, 1000, 1000, 1000, ANGLE_SET);
   rate1.sleep();
   write_SeriesPort_modbus(1000, 1000, 1000, 1000, 1000, 160, ANGLE_SET);
   rate1.sleep();
   write_SeriesPort_modbus(1000, 1000, 1000, 424, 628, 160, ANGLE_SET);
}
