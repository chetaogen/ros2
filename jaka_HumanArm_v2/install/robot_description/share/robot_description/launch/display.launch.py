...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('robot_description')  #需要修改的地方:robot_description 修改为对应的功能包名称
    ...
    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        'rviz_config_file',
        default_value=os.path.join(bringup_dir, 'rviz', 'urdf.rviz'), #需要修改的地方:urdf.rviz 改为rviz中对应的.rviz文件名称
    ...
    declare_urdf_cmd = DeclareLaunchArgument(
        'urdf_file',
        default_value=os.path.join(bringup_dir, 'urdf', 'urdf.urdf'),#需要修改的地方
        description='Whether to start RVIZ') 
